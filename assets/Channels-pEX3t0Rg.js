import{j as e}from"./vendor-ui-p5Vs906c.js";import{r,u as Re}from"./vendor-react-Bj6Tv0k8.js";import{s as f,v as ee,x as te,y as se,z as ae,O as xe,A as ne,B as m,L as fe,I as y,P as je,j as w,u as Qe,q as Be,l as Ne,t as U,C as oe,m as we,p as ce,w as He,n as $e,o as Ve,h as de,F as Je}from"./index-uGv6Srkn.js";import{C as E}from"./channelService-BgZie5qh.js";import{L as g}from"./label-Dx_3aB0r.js";import{T as X}from"./textarea-BXa2x8qR.js";import{S as ue,a as me,b as he,c as pe,d as T}from"./select-C2YxDKpU.js";import{S as Ke}from"./switch-Bh-4mfBJ.js";import{A as _e,a as Ee,b as qe,c as Ie,d as ke,e as De,f as ze,g as Ae}from"./alert-dialog-D2uugHiM.js";import{S as We}from"./scroll-area-CHop9J2g.js";import{B as Te}from"./badge-D9OoQTFe.js";import{P as ve}from"./plus-Cqe3jJuL.js";import{P as Se}from"./pencil-Ing808gM.js";import{T as Pe}from"./trash-2-auuIKaL7.js";import{A as B,a as W}from"./alert-O3Gi5n1D.js";import{M as Z}from"./message-circle-C9Ip4-L2.js";import{C as ge}from"./circle-alert-B9XhOKHm.js";import{B as Ze}from"./book-open-CR6pzEmO.js";import{Z as Xe}from"./zap-BOLUTk5Y.js";import"./vendor-recharts-BBfNJ8B2.js";import"./vendor-query-aZwRb222.js";import"./vendor-supabase-Cxj50Fxc.js";import"./chevron-down-whdKQymu.js";const k=[{id:"general",name:"General Knowledge",subject:"General",description:"Broad general knowledge quizzes covering various topics",prompt:`You are a quiz generator for general knowledge topics.
...
IMPORTANT:
- [Add your specific requirements]`})),C(!0)},L=()=>{C(!1),O(null),N({name:"",subject:"",description:"",prompt:""})},Y=async()=>{if(!h.name.trim()||!h.subject.trim()||!h.prompt.trim()){w.error("Please fill in all required fields");return}S(!0);try{const{data:{user:a}}=await f.auth.getUser();if(!a)throw new Error("Not authenticated");if(await H.isTemplateNameTaken(a.id,h.name,o&&!o.is_default?o.id:void 0)){w.error("A template with this name already exists"),S(!1);return}o&&!o.is_default?(await H.updateTemplate(o.id,h),w.success("Template updated successfully")):(await H.createTemplate(a.id,h),w.success(o?.is_default?"Template saved as a new custom template":"Template created successfully")),L(),G()}catch(a){console.error("Error saving template:",a);const i=a.message||"Failed to save template";w.error(`Failed to save template: ${i}`),(i.includes('relation "user_templates" does not exist')||i.includes("Could not find the table")||a.code==="PGRST205")&&w.error("Database table missing. Please run the migration script in Supabase SQL Editor.",{duration:1e4})}finally{S(!1)}},V=async()=>{if(I){if(I.is_default&&!_){w.error("You cannot delete default templates."),q(!1);return}try{await H.deleteTemplate(I.id),w.success("Template deleted successfully"),q(!1),F(null),G()}catch(a){console.error("Error deleting template:",a);const i=a.message||"Failed to delete template";w.error(`Failed to delete template: ${i}`)}}},J=a=>{F(a),q(!0)},R=a=>{c&&c(a.id),l(!1)};return e.jsxs(e.Fragment,{children:[e.jsx(ee,{open:p,onOpenChange:l,children:e.jsxs(te,{className:"max-w-3xl max-h-[80vh]",children:[e.jsxs(se,{children:[e.jsxs(ae,{className:"flex items-center gap-2",children:[e.jsx(xe,{className:"w-5 h-5"}),"Manage Templates"]}),e.jsx(ne,{children:"Create and manage your quiz templates. All templates can be edited or deleted."})]}),e.jsx("div",{className:"flex justify-end mb-4",children:e.jsxs(m,{onClick:()=>A(),size:"sm",children:[e.jsx(ve,{className:"w-4 h-4 mr-2"}),"New Template"]})}),v?e.jsx("div",{className:"flex items-center justify-center py-8",children:e.jsx(fe,{className:"w-6 h-6 animate-spin"})}):e.jsx(We,{className:"h-[400px] pr-4",children:e.jsxs("div",{className:"space-y-3",children:[d.map(a=>e.jsxs("div",{className:"flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors",children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"font-medium truncate",children:a.name}),a.is_default?e.jsx(Te,{variant:"secondary",className:"text-xs",children:"Default"}):e.jsx(Te,{variant:"outline",className:"text-xs",children:"Custom"})]}),e.jsx("p",{className:"text-sm text-muted-foreground truncate",children:a.description||a.subject})]}),e.jsxs("div",{className:"flex items-center gap-2 ml-4",children:[e.jsx(m,{variant:"outline",size:"sm",onClick:()=>R(a),children:"Use"}),(_||!a.is_default)&&e.jsxs(e.Fragment,{children:[e.jsx(m,{variant:"ghost",size:"icon",onClick:()=>A(a),children:e.jsx(Se,{className:"w-4 h-4"})}),e.jsx(m,{variant:"ghost",size:"icon",className:"text-destructive hover:text-destructive",onClick:()=>J(a),children:e.jsx(Pe,{className:"w-4 h-4"})})]}),!_&&a.is_default&&e.jsx(m,{variant:"ghost",size:"icon",onClick:()=>A(a),title:"Save as custom template",children:e.jsx(Se,{className:"w-4 h-4"})})]})]},a.id)),d.length===0&&e.jsx("div",{className:"text-center py-8 text-muted-foreground",children:"No templates found. Create your first custom template!"})]})})]})}),e.jsx(ee,{open:D,onOpenChange:a=>!a&&L(),children:e.jsxs(te,{className:"max-w-2xl max-h-[90vh] overflow-y-auto",children:[e.jsxs(se,{children:[e.jsx(ae,{children:o?"Edit Template":"Create New Template"}),e.jsx(ne,{children:o?"Update your custom template settings":"Create a new quiz template with custom guidelines"})]}),e.jsxs("div",{className:"space-y-4 py-4",children:[e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx(g,{htmlFor:"name",children:"Template Name *"}),e.jsx(y,{id:"name",placeholder:"e.g., Indian History",value:h.name,onChange:a=>N({...h,name:a.target.value})})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(g,{htmlFor:"subject",children:"Subject *"}),e.jsx(y,{id:"subject",placeholder:"e.g., History",value:h.subject,onChange:a=>N({...h,subject:a.target.value})})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(g,{htmlFor:"description",children:"Description"}),e.jsx(y,{id:"description",placeholder:"Brief description of this template",value:h.description,onChange:a=>N({...h,description:a.target.value})})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(g,{htmlFor:"prompt",children:"System Prompt *"}),e.jsx(X,{id:"prompt",placeholder:"Enter the AI system prompt for this template...",value:h.prompt,onChange:a=>N({...h,prompt:a.target.value}),className:"min-h-[200px] font-mono text-sm"}),e.jsx("p",{className:"text-xs text-muted-foreground",children:"This prompt guides the AI when generating quiz questions for this template."})]})]}),e.jsxs(je,{children:[e.jsx(m,{variant:"outline",onClick:L,disabled:z,children:"Cancel"}),e.jsxs(m,{onClick:Y,disabled:z,children:[z&&e.jsx(fe,{className:"w-4 h-4 mr-2 animate-spin"}),o?"Update Template":"Create Template"]})]})]})}),e.jsx(_e,{open:ie,onOpenChange:q,children:e.jsxs(Ee,{children:[e.jsxs(qe,{children:[e.jsx(Ie,{children:"Delete Template"}),e.jsxs(ke,{children:['Are you sure you want to delete "',I?.name,'"? This action cannot be undone.']})]}),e.jsxs(De,{children:[e.jsx(ze,{children:"Cancel"}),e.jsx(Ae,{onClick:V,className:"bg-destructive text-destructive-foreground",children:"Delete"})]})]})})]})}function St(){const[p,l]=r.useState([]),[c,d]=r.useState(!0),[u,v]=r.useState(!1),[s,o]=r.useState(null),[O,D]=r.useState(!1),[C,ie]=r.useState({}),[q,I]=r.useState(null),[F,z]=r.useState(!1),[S,_]=r.useState(!1),[M,h]=r.useState(null),[N,$]=r.useState(""),[G,A]=r.useState(!1),[L,Y]=r.useState(!1),[V,J]=r.useState(null),[R,a]=r.useState(!1),{toast:i}=Qe(),j=Re(),[x,Q]=r.useState({name:"",description:"",telegram_channel_id:"",telegram_bot_token:""}),P=r.useCallback(async()=>{try{const{data:{user:t}}=await f.auth.getUser();if(!t)return;const n=await E.getUserChannels(t.id);l(n)}catch(t){const n=t instanceof Error?t.message:"Failed to load channels";i({title:"Error",description:n,variant:"destructive"})}finally{d(!1)}},[i]);r.useEffect(()=>{P()},[P]);const{getLimit:Ue,isSuperAdmin:ye}=Be(),re=Ue("max_telegram_channels")||1,Oe=async()=>{if(!x.name.trim()){i({title:"Validation Error",description:"Channel name is required",variant:"destructive"});return}if(!ye&&p.length>=re){i({title:"Limit Reached",description:`Your current plan allows max ${re} channel(s). Please upgrade for more.`,variant:"destructive"});return}z(!0);try{const{data:{user:t}}=await f.auth.getUser();if(!t)return;await E.createChannel(t.id,x),i({title:"Success",description:"Channel created successfully"}),v(!1),le(),P()}catch(t){i({title:"Error",description:t instanceof Error?t.message:"Failed to create channel",variant:"destructive"})}finally{z(!1)}},le=()=>{Q({name:"",description:"",telegram_channel_id:"",telegram_bot_token:""}),h(null)},Fe=async()=>{const t=x.telegram_channel_id.trim();if(!t){i({title:"Missing chat ID",description:"Please enter the Telegram channel/chat ID to test connection",variant:"destructive"});return}_(!0),h(null);try{const n=await E.testTelegramConnection(t,void 0);h(n),n.success?i({title:"Connection Successful",description:n.message}):i({title:"Connection Failed",description:n.message,variant:"destructive"})}catch(n){const b=n instanceof Error?n.message:"Test failed";h({success:!1,message:b}),i({title:"Error",description:b,variant:"destructive"})}finally{_(!1)}},Me=async()=>{if(!s)return;const t=s.telegram_channel_id?.trim();if(!t){i({title:"Missing chat ID",description:"Please enter the Telegram channel/chat ID to test connection",variant:"destructive"});return}_(!0);try{const n=await E.testTelegramConnection(t,s.id);n.success?i({title:"Connection Successful",description:n.message}):i({title:"Connection Failed",description:n.message,variant:"destructive"})}catch(n){i({title:"Error",description:n instanceof Error?n.message:"Connection test failed",variant:"destructive"})}finally{_(!1)}},Ge=async()=>{if(V){a(!0);try{const{data:{user:t}}=await f.auth.getUser();if(!t)return;await E.deleteChannel(V,t.id),i({title:"Success",description:"Channel deleted successfully"}),Y(!1),J(null),P()}catch(t){i({title:"Error",description:t instanceof Error?t.message:"Failed to delete channel",variant:"destructive"})}finally{a(!1)}}},Le=async t=>{try{const{data:{user:n}}=await f.auth.getUser();if(!n)return;await E.updateChannel(t.id,n.id,{name:t.name.trim(),description:t.description?.trim()||"",telegram_channel_id:t.telegram_channel_id?.trim()||void 0,telegram_bot_token:t.telegram_bot_token?.trim()||void 0,settings:t.settings}),i({title:"Success",description:"Settings updated successfully"}),P()}catch(n){i({title:"Error",description:n instanceof Error?n.message:"Failed to update settings",variant:"destructive"})}},Ce=r.useCallback(async(t,n)=>{try{const b=await E.getChannelStats(t,n);ie(K=>({...K,[t]:{documentCount:b.documentCount,quizCount:b.quizCount}}))}catch{}},[]),Ye=async t=>{if(console.log("handleManualGeneration called for channel:",t.id,t.name),console.log("Channel settings:",t.settings),console.log("telegram_channel_id:",t.telegram_channel_id),!t.telegram_channel_id){i({title:"Error",description:"Please configure Telegram credentials first",variant:"destructive"});return}if(!t.settings.default_subject){console.log("No default_subject set for channel"),i({title:"Error",description:"Please set a default subject for quiz generation",variant:"destructive"});return}I(t.id);try{console.log("Calling ChannelService.triggerAutoGeneration...");const n=await E.triggerAutoGeneration(t.id,!0);if(console.log("triggerAutoGeneration result:",n),!n.success)throw new Error(n.message||"Failed to generate quiz");i({title:"Success",description:`Quiz generated and sent to ${t.name}`}),P()}catch(n){console.error("Quiz generation error:",n),i({title:"Error",description:n instanceof Error?n.message:"Failed to generate quiz. Please try again.",variant:"destructive"})}finally{I(null)}},be=t=>{if(!s||!t)return;const n=et(t);if(!n)return;const b=n.id!=="general"&&n.id!=="custom"?n.subject:s.settings.default_subject,K=tt(b,s.settings.default_language,"",t);o({...s,settings:{...s.settings,system_prompt:K,default_subject:b}}),$(t),i({title:"Template Applied",description:`Applied "${n.name}" template. You can customize the prompt further.`})};return r.useEffect(()=>{const t=async()=>{const{data:{user:n}}=await f.auth.getUser();n&&await Promise.all(p.map(b=>Ce(b.id,n.id)))};p.length>0&&t()},[p,Ce]),c?e.jsx(Ne,{children:e.jsxs("div",{className:"container mx-auto p-6",children:[e.jsxs("div",{className:"flex justify-between items-center mb-6",children:[e.jsxs("div",{children:[e.jsx(U,{className:"h-8 w-32 mb-2"}),e.jsx(U,{className:"h-4 w-64"})]}),e.jsx(U,{className:"h-10 w-32"})]}),e.jsx("div",{className:"grid gap-6 md:grid-cols-2 lg:grid-cols-3",children:Array.from({length:3}).map((t,n)=>e.jsxs(oe,{children:[e.jsxs(we,{children:[e.jsx(U,{className:"h-6 w-32 mb-2"}),e.jsx(U,{className:"h-4 w-48"})]}),e.jsx(ce,{children:e.jsx(U,{className:"h-20 w-full"})})]},n))})]})}):e.jsx(Ne,{children:e.jsxs("div",{className:"container mx-auto p-6",children:[e.jsxs("div",{className:"flex justify-between items-center mb-6",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-3xl font-bold",children:"Channels"}),e.jsxs("p",{className:"text-muted-foreground",children:["Manage your Telegram channels ",ye?`(${p.length} active)`:`(${p.length} / ${re} used)`]})]}),e.jsxs(ee,{open:u,onOpenChange:t=>{v(t),t||le()},children:[e.jsx(He,{asChild:!0,children:e.jsxs(m,{children:[e.jsx(ve,{className:"mr-2 h-4 w-4"}),"Create Channel"]})}),e.jsxs(te,{children:[e.jsxs(se,{children:[e.jsx(ae,{children:"Create New Channel"}),e.jsx(ne,{children:"Add a new Telegram channel with its own knowledge base"})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx(g,{htmlFor:"name",children:"Channel Name *"}),e.jsx(y,{id:"name",value:x.name,onChange:t=>Q({...x,name:t.target.value}),placeholder:"My Channel"}),!x.name.trim()&&x.name!==""&&e.jsx("p",{className:"text-xs text-destructive mt-1",children:"Channel name is required"})]}),e.jsxs("div",{children:[e.jsx(g,{htmlFor:"description",children:"Description (Optional)"}),e.jsx(X,{id:"description",value:x.description,onChange:t=>Q({...x,description:t.target.value}),placeholder:"Channel description..."})]}),e.jsxs("div",{children:[e.jsx(g,{htmlFor:"telegram_channel_id",children:"Telegram Chat ID (Optional)"}),e.jsx(y,{id:"telegram_channel_id",value:x.telegram_channel_id,onChange:t=>Q({...x,telegram_channel_id:t.target.value}),placeholder:"@mychannel or -1001234567890"})]}),e.jsxs("div",{children:[e.jsx(g,{htmlFor:"telegram_bot_token",children:"Telegram Bot Token (Optional)"}),e.jsx(y,{id:"telegram_bot_token",type:"password",value:x.telegram_bot_token,onChange:t=>Q({...x,telegram_bot_token:t.target.value}),placeholder:"Enter bot token from @BotFather"}),e.jsx("p",{className:"text-xs text-muted-foreground mt-1",children:"Required to post to this channel. You can also set a global token in Settings."})]}),x.telegram_channel_id&&e.jsxs("div",{className:"space-y-2",children:[e.jsxs(m,{type:"button",variant:"outline",size:"sm",onClick:Fe,disabled:S||!x.telegram_channel_id,className:"w-full",children:[e.jsx(Z,{className:"mr-2 h-4 w-4"}),S?"Testing...":"Test Connection"]}),M&&e.jsxs(B,{variant:M.success?"default":"destructive",children:[e.jsx(ge,{className:"h-4 w-4"}),e.jsx(W,{className:"text-xs",children:M.message})]})]})]}),e.jsxs(je,{children:[e.jsx(m,{variant:"outline",onClick:()=>{v(!1),le()},children:"Cancel"}),e.jsx(m,{onClick:Oe,disabled:!x.name.trim()||F,children:F?"Creating...":"Create"})]})]})]})]}),p.length===0?e.jsx(oe,{children:e.jsxs(ce,{className:"flex flex-col items-center justify-center py-12",children:[e.jsx(Z,{className:"h-12 w-12 text-muted-foreground mb-4"}),e.jsx("p",{className:"text-muted-foreground mb-4",children:"No channels yet"}),e.jsxs(m,{onClick:()=>v(!0),children:[e.jsx(ve,{className:"mr-2 h-4 w-4"}),"Create Your First Channel"]})]})}):e.jsx("div",{className:"grid gap-6 md:grid-cols-2 lg:grid-cols-3",children:p.map(t=>e.jsxs(oe,{children:[e.jsx(we,{children:e.jsxs("div",{className:"flex justify-between items-start",children:[e.jsxs("div",{children:[e.jsx($e,{children:t.name}),e.jsx(Ve,{children:t.description||"No description"})]}),e.jsx(m,{variant:"ghost",size:"sm",onClick:()=>{J(t.id),Y(!0)},className:"text-muted-foreground hover:text-destructive",children:e.jsx(Pe,{className:"h-4 w-4"})})]})}),e.jsxs(ce,{className:"space-y-4",children:[C[t.id]&&e.jsxs("div",{className:"flex gap-4 text-xs text-muted-foreground",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx(Ze,{className:"h-3 w-3 mr-1"}),C[t.id].documentCount," docs"]}),e.jsxs("div",{className:"flex items-center",children:[e.jsx(de,{className:"h-3 w-3 mr-1"}),C[t.id].quizCount," quizzes"]})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs(m,{variant:"outline",size:"sm",className:"flex-1",onClick:()=>j(`/dashboard/documents?channel=${t.id}`),children:[e.jsx(Je,{className:"mr-2 h-4 w-4"}),"Documents"]}),e.jsxs(m,{variant:"outline",size:"sm",className:"flex-1",onClick:()=>{o(t),$(""),D(!0)},children:[e.jsx(xe,{className:"mr-2 h-4 w-4"}),"Settings"]})]}),t.settings.auto_generate_quizzes&&e.jsxs(m,{variant:"secondary",size:"sm",className:"w-full",onClick:()=>Ye(t),disabled:q===t.id,children:[e.jsx(Xe,{className:"mr-2 h-4 w-4"}),q===t.id?"Generating...":"Generate Quiz Now"]}),t.telegram_channel_id&&e.jsxs("div",{className:"text-sm text-muted-foreground",children:[e.jsx(Z,{className:"inline h-3 w-3 mr-1"}),t.telegram_channel_id]}),t.settings.auto_generate_quizzes&&e.jsxs("div",{className:"text-sm bg-green-50 dark:bg-green-950 text-green-700 dark:text-green-300 px-3 py-2 rounded-md",children:[e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(de,{className:"h-3 w-3"}),"Auto-generation enabled"]}),e.jsxs("div",{className:"text-xs mt-1 space-y-0.5",children:[t.settings.default_subject&&e.jsxs("div",{children:["Subject: ",t.settings.default_subject]}),e.jsxs("div",{children:["Frequency: ",t.settings.generation_frequency]}),e.jsxs("div",{children:["Questions: ",t.settings.questions_per_quiz]})]})]}),t.settings.auto_generate_quizzes&&!t.telegram_channel_id&&e.jsxs(B,{variant:"destructive",children:[e.jsx(ge,{className:"h-4 w-4"}),e.jsx(W,{className:"text-xs",children:"Missing Telegram channel ID"})]}),t.settings.auto_generate_quizzes&&!t.settings.system_prompt&&e.jsxs(B,{children:[e.jsx(ge,{className:"h-4 w-4"}),e.jsx(W,{className:"text-xs",children:"No system prompt configured. Add one in Settings for better quiz quality."})]})]})]},t.id))}),e.jsx(ee,{open:O,onOpenChange:D,children:e.jsxs(te,{className:"max-w-2xl max-h-[90vh] overflow-y-auto",children:[e.jsxs(se,{children:[e.jsxs(ae,{children:["Edit Channel: ",s?.name]}),e.jsx(ne,{children:"Update channel details and configure auto quiz generation settings"})]}),s&&e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h3",{className:"font-medium",children:"Channel Information"}),e.jsxs("div",{className:"grid grid-cols-1 gap-4",children:[e.jsxs("div",{children:[e.jsx(g,{htmlFor:"edit-name",children:"Channel Name *"}),e.jsx(y,{id:"edit-name",value:s.name,onChange:t=>o({...s,name:t.target.value}),placeholder:"My Channel"})]}),e.jsxs("div",{children:[e.jsx(g,{htmlFor:"edit-description",children:"Description (Optional)"}),e.jsx(X,{id:"edit-description",value:s.description||"",onChange:t=>o({...s,description:t.target.value}),placeholder:"Channel description..."})]})]})]}),e.jsx(B,{className:"bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-900",children:e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("p",{className:"text-sm font-semibold text-blue-800 dark:text-blue-300",children:"Quick Setup Instructions:"}),e.jsxs("ol",{className:"text-xs text-blue-700 dark:text-blue-400 list-decimal ml-4 space-y-1",children:[e.jsxs("li",{children:["Add your bot to your channel as an ",e.jsx("strong",{children:"Administrator"}),"."]}),e.jsxs("li",{children:["Ensure it has ",e.jsx("strong",{children:'"Post Messages"'})," permission."]}),e.jsxs("li",{children:["Copy the Channel ID (e.g., ",e.jsx("code",{className:"bg-blue-100 dark:bg-blue-900 px-1 rounded",children:"-100..."}),")."]}),e.jsxs("li",{children:["Enter the token from ",e.jsx("code",{className:"bg-blue-100 dark:bg-blue-900 px-1 rounded",children:"@BotFather"})," below."]})]})]})}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h3",{className:"font-medium",children:"Telegram Configuration"}),e.jsxs("div",{className:"grid grid-cols-1 gap-4",children:[e.jsxs("div",{children:[e.jsx(g,{htmlFor:"edit-telegram-channel-id",children:"Telegram Chat ID"}),e.jsx(y,{id:"edit-telegram-channel-id",value:s.telegram_channel_id||"",onChange:t=>o({...s,telegram_channel_id:t.target.value}),placeholder:"@mychannel or -1001234567890"})]}),e.jsxs("div",{children:[e.jsx(g,{htmlFor:"edit-telegram-bot-token",children:"Telegram Bot Token"}),e.jsx(y,{id:"edit-telegram-bot-token",type:"password",value:s.telegram_bot_token||"",onChange:t=>o({...s,telegram_bot_token:t.target.value}),placeholder:"Enter bot token"})]}),s.telegram_channel_id&&e.jsxs(m,{type:"button",variant:"outline",size:"sm",onClick:Me,disabled:S||!s.telegram_channel_id,children:[e.jsx(Z,{className:"mr-2 h-4 w-4"}),S?"Testing...":"Test Connection"]})]})]}),e.jsxs("div",{className:"flex items-center justify-between p-4 bg-muted rounded-lg",children:[e.jsxs("div",{children:[e.jsx(g,{htmlFor:"auto-generate",className:"text-base font-medium",children:"Auto Generate Quizzes"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Automatically generate and send quizzes based on this channel's knowledge base"})]}),e.jsx(Ke,{id:"auto-generate",checked:s.settings.auto_generate_quizzes,onCheckedChange:t=>o({...s,settings:{...s.settings,auto_generate_quizzes:t}})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsx("h3",{className:"font-medium",children:"Quiz Configuration"}),e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsxs("div",{children:[e.jsx(g,{htmlFor:"default-subject",children:"Subject/Topic"}),e.jsx(y,{id:"default-subject",value:s.settings.default_subject,onChange:t=>o({...s,settings:{...s.settings,default_subject:t.target.value}}),placeholder:"e.g., Mathematics, Science..."})]}),e.jsxs("div",{children:[e.jsx(g,{htmlFor:"questions-per-quiz",children:"Questions Per Quiz"}),e.jsx(y,{id:"questions-per-quiz",type:"number",min:"1",max:"50",value:s.settings.questions_per_quiz,onChange:t=>o({...s,settings:{...s.settings,questions_per_quiz:parseInt(t.target.value)||10}})})]})]}),e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsxs("div",{children:[e.jsx(g,{htmlFor:"default-language",children:"Language"}),e.jsxs(ue,{value:s.settings.default_language,onValueChange:t=>o({...s,settings:{...s.settings,default_language:t}}),children:[e.jsx(me,{children:e.jsx(he,{})}),e.jsxs(pe,{children:[e.jsx(T,{value:"bn",children:"Bengali"}),e.jsx(T,{value:"en",children:"English"}),e.jsx(T,{value:"hi",children:"Hindi"})]})]})]}),e.jsxs("div",{children:[e.jsx(g,{htmlFor:"generation-frequency",children:"Frequency"}),e.jsxs(ue,{value:s.settings.generation_frequency,onValueChange:t=>o({...s,settings:{...s.settings,generation_frequency:t}}),children:[e.jsx(me,{children:e.jsx(he,{})}),e.jsxs(pe,{children:[e.jsx(T,{value:"daily",children:"Daily"}),e.jsx(T,{value:"weekly",children:"Weekly"}),e.jsx(T,{value:"bi-weekly",children:"Bi-weekly"}),e.jsx(T,{value:"monthly",children:"Monthly"}),e.jsx(T,{value:"manual",children:"Manual only"})]})]})]})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("h3",{className:"font-medium",children:"AI System Prompt"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(g,{htmlFor:"template-select",className:"text-sm",children:"Template:"}),e.jsxs(ue,{value:N,onValueChange:t=>be(t),children:[e.jsx(me,{className:"w-[180px]",children:e.jsx(he,{placeholder:"Choose template..."})}),e.jsx(pe,{children:k.map(t=>e.jsx(T,{value:t.id,children:t.name},t.id))})]}),e.jsxs(m,{variant:"outline",size:"sm",onClick:()=>A(!0),children:[e.jsx(xe,{className:"w-4 h-4 mr-1"}),"Manage"]})]})]}),e.jsxs(B,{children:[e.jsx(de,{className:"h-4 w-4"}),e.jsx(W,{children:"The system prompt tells the AI how to generate quiz questions for this specific channel. It ensures questions are created only from this channel's knowledge base and follow the appropriate format."})]}),e.jsx(X,{id:"system-prompt",value:s.settings.system_prompt,onChange:t=>o({...s,settings:{...s.settings,system_prompt:t.target.value}}),placeholder:`Enter custom instructions for the AI quiz generator...

Example: Generate questions focused on practical applications and real-world examples. Include questions that test both recall and understanding. Make explanations educational and clear.`,rows:8,className:"font-mono text-sm"}),e.jsx("p",{className:"text-xs text-muted-foreground",children:"This prompt guides the AI when generating quizzes. It will use ONLY documents uploaded to this channel."})]}),C[s.id]&&e.jsxs("div",{className:"p-4 bg-muted rounded-lg",children:[e.jsx("h3",{className:"font-medium mb-2",children:"Channel Knowledge Base"}),e.jsxs("div",{className:"flex gap-6 text-sm",children:[e.jsxs("div",{children:[e.jsx("span",{className:"text-muted-foreground",children:"Documents:"})," ",e.jsx("span",{className:"font-medium",children:C[s.id].documentCount})]}),e.jsxs("div",{children:[e.jsx("span",{className:"text-muted-foreground",children:"Quizzes Generated:"})," ",e.jsx("span",{className:"font-medium",children:C[s.id].quizCount})]})]}),C[s.id].documentCount===0&&e.jsx("p",{className:"text-xs text-amber-600 mt-2",children:"No documents uploaded yet. Upload PDFs to build the knowledge base for better quiz generation."})]})]}),e.jsxs(je,{children:[e.jsx(m,{variant:"outline",onClick:()=>D(!1),children:"Cancel"}),e.jsx(m,{onClick:()=>{s&&(Le(s),D(!1))},children:"Save Changes"})]})]})}),e.jsx(_e,{open:L,onOpenChange:Y,children:e.jsxs(Ee,{children:[e.jsxs(qe,{children:[e.jsx(Ie,{children:"Are you absolutely sure?"}),e.jsx(ke,{children:"This action cannot be undone. This will permanently delete the channel. Associated documents and quizzes will remain but will no longer be linked to this channel."})]}),e.jsxs(De,{children:[e.jsx(ze,{disabled:R,children:"Cancel"}),e.jsx(Ae,{onClick:t=>{t.preventDefault(),Ge()},disabled:R,className:"bg-destructive text-destructive-foreground hover:bg-destructive/90",children:R?e.jsxs(e.Fragment,{children:[e.jsx(fe,{className:"mr-2 h-4 w-4 animate-spin"}),"Deleting..."]}):"Delete Channel"})]})]})}),e.jsx(st,{open:G,onOpenChange:A,onTemplateSelect:t=>be(t)})]})})}export{St as default};
