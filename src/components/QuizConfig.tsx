  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (questionCount === "custom") {
      ...
      return;
        ...
        onStartQuiz({
          topic: selectedKBTopic ? selectedKBTopic.topic_name : topic.trim(),
        ...
        <div className="space-y-2">
          ...
          {selectedKBTopic && (
            <p className="text-xs text-muted-foreground">
              AI will use the topic&apos;s instructions and context for quiz generation.
            </p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select value={language} onValueChange={(v) => setLanguage(v as "bn" | "en" | "hi")}>
            ...
            <SelectContent>
              ...
              <SelectItem value="hi">Hindi (हिन्दী)</SelectItem>
            </SelectContent>
          </Select>
        </div>
