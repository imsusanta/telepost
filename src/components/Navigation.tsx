            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              {isLoggedIn ? (
                <Button
                  ...
                  size="sm"
                  className="h-10 px-5 text-sm font-semibold bg-gradient-to-r from-[#0088cc] to-[#0077b5] hover:from-[#0077b5] hover:to-[#006699] text-white rounded-xl gap-2 shadow-md shadow-[#0088cc]/20 transition-all hover:scale-[1.02]"
                >
                ...
                <div className="pt-3 mt-2 border-t border-border flex flex-col gap-2">
                  {isLoggedIn ? (
                    <Button
                      onClick={handleGoToDashboard}
                      size="sm"
                      className="h-9 text-sm font-medium bg-[#0088cc] hover:bg-[#0077b5] text-white rounded-xl gap-2"
                    >
                      <LayoutDashboard className="w-4 h-4" />
                      Go to Dashboard
                    </Button>
                    ...
                    <Button
                      onClick={handleGetStarted}
                      size="sm"
                      className="h-9 text-sm font-medium bg-[#0088cc] hover:bg-[#0077b5] text-white rounded-xl"
                    >
                      Get Started
                    </Button>
                  )}
