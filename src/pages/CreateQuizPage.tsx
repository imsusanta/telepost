...
export default function CreateQuizPage() {
  ...
  useEffect(() => {
    ...
    initializeData();
  }, [loadChannels, loadQuestions, loadStats, searchParams]); // Run once on mount
          ...
          <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm md:text-base text-muted-foreground">Generate AI-powered quizzes, manual input, and question bank</p>
              </div>
            </div>
