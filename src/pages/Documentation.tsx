...
const TableOfContents = ({ mobile = false }: { mobile?: boolean }) => (
    <nav
        ...
        className={
            mobile
                ? "mb-10 rounded-2xl border border-border/50 bg-card/30 p-5 lg:hidden"
                : "hidden lg:block sticky top-28 rounded-2xl border border-border/50 bg-card/40 backdrop-blur-xl p-5 shadow-lg shadow-black/5"
        }
    >
        <div className="flex items-center gap-2 mb-4">
            <BookOpen className="w-5 h-5 text-primary" />
            <h2 className="font-bold text-base">Table of Contents</h2>
        </div>
        <ul className="space-y-1.5">
            {tocItems.map((item) => (
                <li key={item.href}>
                    <a
                        href={item.href}
                        className="flex items-start gap-2 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-primary hover:bg-primary/5 transition-all duration-200 group"
                    >
                        <ChevronRight className="w-4 h-4 mt-0.5 shrink-0 text-primary/50 group-hover:translate-x-0.5 transition-transform" />
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-32 pb-20">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
                    ...
                    <div className="lg:col-span-9 min-w-0">
                        ...
                        <section id="create-account" className="mb-20 scroll-mt-28">
                        ...
                        <section id="create-bot" className="mb-20 scroll-mt-28">
                            <div className="flex items-center gap-4 mb-8">
                        ...
                        <section id="connect-bot" className="mb-20 scroll-mt-28">
                            <div className="flex items-center gap-4 mb-8">
                        ...
                        <section id="add-channels" className="mb-20 scroll-mt-28">
                            <div className="flex items-center gap-4 mb-8">
                        ...
                        <section id="generate-quizzes" className="mb-20 scroll-mt-28">
                            <div className="flex items-center gap-4 mb-8">
                        ...
                        <section id="schedule-post" className="mb-20 scroll-mt-28">
                            <div className="flex items-center gap-4 mb-8">
                        ...
                        <section id="question-bank" className="mb-20 scroll-mt-28">
                            <div className="flex items-center gap-4 mb-8">
