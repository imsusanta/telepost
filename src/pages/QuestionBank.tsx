...
import { Database, RefreshCw, Search, Trash2, List, Zap, Download, Pencil, ChevronLeft, ChevronRight, ArrowDownAz, ArrowUpAz, Globe, Lock } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <Tabs defaultValue="questions" className="w-full">
          <TabsList className={`grid w-full h-auto ${hasAIAccess ? "grid-cols-2" : "grid-cols-1"}`}>
