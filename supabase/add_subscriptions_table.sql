...
-- - usage_tracking table (quota tracking)
-- =============================================
...
RETURNS TABLE (plan_name TEXT, plan_features JSONB) AS $$
BEGIN
  RETURN QUERY
  SELECT sp.name, jsonb_build_object(
...
-- ✅ Done! The subscriptions table is now ready to use.
